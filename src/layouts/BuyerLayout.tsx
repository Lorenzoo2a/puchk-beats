...
import { Library, ShoppingBag, Heart, Settings } from "lucide-react";

const links = [
  { icon: Library, label: "Bibliothèque", path: "/library" },
  { icon: ShoppingBag, label: "Commandes", path: "/library/orders" },
  { icon: Heart, label: "Favoris", path: "/library/favorites" },
  { icon: Settings, label: "Paramètres", path: "/library/settings" },
];
        ...
        <div className="p-4 border-b border-[rgba(255,107,26,0.08)]">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="block text-[9px] text-white/30 uppercase tracking-widest">Mon Compte</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-[rgba(255,107,26,0.08)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block text-[10px] text-white/40">kxzma@puchk.io</span>
            </div>
          </div>
        </div>
      </aside>
