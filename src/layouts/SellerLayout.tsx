...
const links = [
  ...
  { icon: Upload, label: "Publier un Kit", path: "/dashboard/kits/new" },
        ...
        <div className="p-4 border-t border-[rgba(255,107,26,0.08)]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <Link to="/producer/kxzma" className="block text-[10px] text-puchk-orange hover:underline">Voir mon profil</Link>
            </div>
          </div>
        </div>
      </aside>
